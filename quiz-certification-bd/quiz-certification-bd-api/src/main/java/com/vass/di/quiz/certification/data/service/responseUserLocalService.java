...
/**
 * Provides the local service interface for responseUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dgarces
 * @see responseUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface responseUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link responseUserLocalServiceUtil} to access the response user local service. Add custom service methods to <code>com.vass.di.quiz.certification.data.service.impl.responseUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public responseUser addresponseUser(responseUser responseUser);
	...
	public responseUser createresponseUser(long responseUserId);
	...
	public responseUser deleteresponseUser(long responseUserId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public responseUser deleteresponseUser(responseUser responseUser);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public responseUser fetchresponseUser(long responseUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public responseUser getresponseUser(long responseUserId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<responseUser> getresponseUsers(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public responseUser updateresponseUser(responseUser responseUser);
